...
export function Home() {
  ...
  if (loading) return <div className={styles.loadingContainer}><Spinner /></div>;
      ...
      <div className={styles.pageContainer}>
        ...
        <main className={styles.mainContent}>
          ...
          <div className={styles.carouselContainer}>
            ...
            <button className={`${styles.scrollButton} ${styles.leftBtn}`} onClick={() => scroll('left')}>‹</button>
              ...
              {products.slice(0, 10).map((product) => (
                  <div key={product.id} className={styles.productCard}>
                    ...
                    <div className={styles.imageContainer}>
                        <img
                          src={product.image_url || "https://placehold.co/400?text=Sin+Imagen"} 
                          alt={product.name}
            ...
            <button className={`${styles.scrollButton} ${styles.rightBtn}`} onClick={() => scroll('right')}>›</button>
          </div>
        </main>
      </div>
    </>
